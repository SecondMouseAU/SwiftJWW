...
#
# Part of the ecosystem's code-style policy (SwiftJWW#9); see
...
# judge which case it is. Report-only: always exits 0, for the same reason a
# codebase nobody has swept yet shouldn't fail every file above a threshold
# on day one: that punishes the report instead of the problem.
#
# Usage:
